...
public class HttpStatusOriginResponseActionConfigBean extends HttpResponseActionConfigBean {
    ...
    public HttpStatusOriginResponseActionConfigBean(int statusCode, int maxNumRetries, long backoffInterval, ResponseAction action) {
    ...
    public HttpStatusOriginResponseActionConfigBean() {
        // needed for UI
    }
